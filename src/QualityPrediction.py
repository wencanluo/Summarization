...
def get_Quality_RubricFeatures(excelfile, prob, titledir):#feature are inspired from decision tree
    reload(sys)
    sys.setdefaultencoding('utf8')
...
def WriteQuality2Weka_New(excelfile, prob, titledir, output):#feature are inspired from decision tree
    head, types, data = get_Quality_RubricFeatures(excelfile, prob, titledir)
    fio.ArffWriter(output, head, types, "Quality", data)
